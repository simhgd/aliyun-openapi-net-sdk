...
namespace Aliyun.Acs.TeslaMaxCompute.Model.V20171130
{
    public class GetProjectInfoRequest : RpcAcsRequest<GetProjectInfoResponse>
    {
        public GetProjectInfoRequest()
            : base("TeslaMaxCompute", "2017-11-30", "GetProjectInfo")
        {
        }
        ...
        public override GetProjectInfoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
