...
{
    public class GetUserInfoRequest : RpcAcsRequest<GetUserInfoResponse>
    {
        public GetUserInfoRequest()
            : base("TeslaMaxCompute", "2017-11-30", "GetUserInfo")
        {
        }
        ...
        public override GetUserInfoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
