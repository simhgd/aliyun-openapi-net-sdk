...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
    public class DescribeLiveStreamTranscodeStreamNumRequest : RpcAcsRequest<DescribeLiveStreamTranscodeStreamNumResponse>
    {
        public DescribeLiveStreamTranscodeStreamNumRequest()
            : base("Cdn", "2014-11-11", "DescribeLiveStreamTranscodeStreamNum")
        {
        }
        ...
        public override DescribeLiveStreamTranscodeStreamNumResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
