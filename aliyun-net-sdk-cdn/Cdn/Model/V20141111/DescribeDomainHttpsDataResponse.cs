...
namespace Aliyun.Acs.Cdn.Model.V20141111
{
	public class DescribeDomainHttpsDataResponse : AcsResponse
	{
		...
		private List<DescribeDomainHttpsData_HttpsStatisticsInfo> httpsStatisticsInfos;
		...
		public List<DescribeDomainHttpsData_HttpsStatisticsInfo> HttpsStatisticsInfos
		{
			get
			{
		...
		public class DescribeDomainHttpsData_HttpsStatisticsInfo
		{
