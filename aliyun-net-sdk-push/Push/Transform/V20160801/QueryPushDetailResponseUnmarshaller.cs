...
namespace Aliyun.Acs.Push.Transform.V20160801
{
    public class QueryPushDetailResponseUnmarshaller
    {
        public static QueryPushDetailResponse Unmarshall(UnmarshallerContext context)
        {
			...
			queryPushDetailResponse.AndroidPopupActivity = context.StringValue("QueryPushDetail.AndroidPopupActivity");
			queryPushDetailResponse.AndroidPopupTitle = context.StringValue("QueryPushDetail.AndroidPopupTitle");
			queryPushDetailResponse.AndroidPopupBody = context.StringValue("QueryPushDetail.AndroidPopupBody");
			...
			queryPushDetailResponse.SmsTemplateName = context.StringValue("QueryPushDetail.SmsTemplateName");
			queryPushDetailResponse.SmsSignName = context.StringValue("QueryPushDetail.SmsSignName");
			queryPushDetailResponse.SmsParams = context.StringValue("QueryPushDetail.SmsParams");
			queryPushDetailResponse.SmsDelaySecs = context.IntegerValue("QueryPushDetail.SmsDelaySecs");
			queryPushDetailResponse.SmsSendPolicy = context.IntegerValue("QueryPushDetail.SmsSendPolicy");
