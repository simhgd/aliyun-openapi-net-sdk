...
namespace Aliyun.Acs.live.Model.V20161101
{
    public class UpdateLiveMixNotifyConfigRequest : RpcAcsRequest<UpdateLiveMixNotifyConfigResponse>
    {
        ...
        public override UpdateLiveMixNotifyConfigResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return UpdateLiveMixNotifyConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}