...
namespace Aliyun.Acs.live.Model.V20161101
{
    public class AddLiveMixConfigRequest : RpcAcsRequest<AddLiveMixConfigResponse>
    {
        ...
        public override AddLiveMixConfigResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return AddLiveMixConfigResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}