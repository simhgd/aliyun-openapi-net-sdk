...
namespace Aliyun.Acs.live.Model.V20161101
{
    public class StartMultipleStreamMixServiceRequest : RpcAcsRequest<StartMultipleStreamMixServiceResponse>
    {
        ...
        public override StartMultipleStreamMixServiceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return StartMultipleStreamMixServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}