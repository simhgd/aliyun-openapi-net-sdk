...
{
    public class AddMultipleStreamMixServiceRequest : RpcAcsRequest<AddMultipleStreamMixServiceResponse>
    {
        public AddMultipleStreamMixServiceRequest()
            : base("live", "2016-11-01", "AddMultipleStreamMixService", "live", "openAPI")
        {
        }
        ...
        public override AddMultipleStreamMixServiceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return AddMultipleStreamMixServiceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}