...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class AddIpRangeRequest : RpcAcsRequest<AddIpRangeResponse>
    {
        ...
        public override AddIpRangeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return AddIpRangeResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}