...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class DescribeInvocationResultsRequest : RpcAcsRequest<DescribeInvocationResultsResponse>
    {
        public DescribeInvocationResultsRequest()
            : base("Ecs", "2014-05-26", "DescribeInvocationResults")
        {
        }
        ...
        public override DescribeInvocationResultsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
