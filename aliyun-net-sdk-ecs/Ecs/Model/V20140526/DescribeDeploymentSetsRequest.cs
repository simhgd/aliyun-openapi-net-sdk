...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class DescribeDeploymentSetsRequest : RpcAcsRequest<DescribeDeploymentSetsResponse>
    {
        public DescribeDeploymentSetsRequest()
            : base("Ecs", "2014-05-26", "DescribeDeploymentSets")
        {
        }
        ...
        public override DescribeDeploymentSetsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
