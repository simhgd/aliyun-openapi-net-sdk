...
namespace Aliyun.Acs.Ecs.Model.V20140526
{
    public class CancelPhysicalConnectionRequest : RpcAcsRequest<CancelPhysicalConnectionResponse>
    {
        public CancelPhysicalConnectionRequest()
            : base("Ecs", "2014-05-26", "CancelPhysicalConnection")
        {
        }
        ...
        public override CancelPhysicalConnectionResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
