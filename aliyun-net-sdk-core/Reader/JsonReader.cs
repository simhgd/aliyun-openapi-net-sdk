...
namespace Aliyun.Acs.Core.Reader
{
    public class JsonReader : IReader
    {
        ...
        {
            return ReadForHideArrayItem(((IEnumerable<char>)response).GetEnumerator(), endpoint);
        }
        ...
        public Dictionary<String, String> ReadForHideArrayItem(IEnumerator<char> ci, String endpoint)
        {
            ct = ci;
            NextChar();
