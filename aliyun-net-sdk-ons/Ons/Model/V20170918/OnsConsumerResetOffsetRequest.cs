...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsConsumerResetOffsetRequest : RpcAcsRequest<OnsConsumerResetOffsetResponse>
    {
        public OnsConsumerResetOffsetRequest()
            : base("Ons", "2017-09-18", "OnsConsumerResetOffset")
        {
        }
        ...
        public override OnsConsumerResetOffsetResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
