...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsTraceQueryByMsgIdRequest : RpcAcsRequest<OnsTraceQueryByMsgIdResponse>
    {
        public OnsTraceQueryByMsgIdRequest()
            : base("Ons", "2017-09-18", "OnsTraceQueryByMsgId")
        {
        }
        ...
        public override OnsTraceQueryByMsgIdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
