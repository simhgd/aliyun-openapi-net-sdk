...
{
    public class OnsSubscriptionListRequest : RpcAcsRequest<OnsSubscriptionListResponse>
    {
        public OnsSubscriptionListRequest()
            : base("Ons", "2017-09-18", "OnsSubscriptionList")
        {
        }
        ...
        public override OnsSubscriptionListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsSubscriptionListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}