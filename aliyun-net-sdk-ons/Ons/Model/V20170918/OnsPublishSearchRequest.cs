...
{
    public class OnsPublishSearchRequest : RpcAcsRequest<OnsPublishSearchResponse>
    {
        public OnsPublishSearchRequest()
            : base("Ons", "2017-09-18", "OnsPublishSearch")
        {
        }
        ...
        public override OnsPublishSearchResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsPublishSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}