...
{
    public class OnsEmpowerListRequest : RpcAcsRequest<OnsEmpowerListResponse>
    {
        public OnsEmpowerListRequest()
            : base("Ons", "2017-09-18", "OnsEmpowerList")
        {
        }
        ...
        public override OnsEmpowerListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsEmpowerListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}