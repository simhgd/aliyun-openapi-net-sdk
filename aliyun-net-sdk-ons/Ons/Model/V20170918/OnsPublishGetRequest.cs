...
{
    public class OnsPublishGetRequest : RpcAcsRequest<OnsPublishGetResponse>
    {
        public OnsPublishGetRequest()
            : base("Ons", "2017-09-18", "OnsPublishGet")
        {
        }
        ...
        public override OnsPublishGetResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsPublishGetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}