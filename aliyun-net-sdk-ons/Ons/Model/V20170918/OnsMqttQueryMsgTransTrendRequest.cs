...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsMqttQueryMsgTransTrendRequest : RpcAcsRequest<OnsMqttQueryMsgTransTrendResponse>
    {
        public OnsMqttQueryMsgTransTrendRequest()
            : base("Ons", "2017-09-18", "OnsMqttQueryMsgTransTrend")
        {
        }
        ...
        public override OnsMqttQueryMsgTransTrendResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
