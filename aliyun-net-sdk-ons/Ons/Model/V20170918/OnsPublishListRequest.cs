...
{
    public class OnsPublishListRequest : RpcAcsRequest<OnsPublishListResponse>
    {
        public OnsPublishListRequest()
            : base("Ons", "2017-09-18", "OnsPublishList")
        {
        }
        ...
        public override OnsPublishListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsPublishListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}