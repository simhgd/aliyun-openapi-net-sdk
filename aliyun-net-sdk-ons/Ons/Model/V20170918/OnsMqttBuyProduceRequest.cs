...
{
    public class OnsMqttBuyProduceRequest : RpcAcsRequest<OnsMqttBuyProduceResponse>
    {
        public OnsMqttBuyProduceRequest()
            : base("Ons", "2017-09-18", "OnsMqttBuyProduce")
        {
        }
        ...
        public override OnsMqttBuyProduceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsMqttBuyProduceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}