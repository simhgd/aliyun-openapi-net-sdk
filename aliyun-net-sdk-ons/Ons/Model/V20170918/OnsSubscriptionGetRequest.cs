...
{
    public class OnsSubscriptionGetRequest : RpcAcsRequest<OnsSubscriptionGetResponse>
    {
        public OnsSubscriptionGetRequest()
            : base("Ons", "2017-09-18", "OnsSubscriptionGet")
        {
        }
        ...
        public override OnsSubscriptionGetResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsSubscriptionGetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}