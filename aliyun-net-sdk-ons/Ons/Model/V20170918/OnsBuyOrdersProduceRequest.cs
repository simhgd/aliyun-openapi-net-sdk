...
{
    public class OnsBuyOrdersProduceRequest : RpcAcsRequest<OnsBuyOrdersProduceResponse>
    {
        public OnsBuyOrdersProduceRequest()
            : base("Ons", "2017-09-18", "OnsBuyOrdersProduce")
        {
        }
        ...
        public override OnsBuyOrdersProduceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsBuyOrdersProduceResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}