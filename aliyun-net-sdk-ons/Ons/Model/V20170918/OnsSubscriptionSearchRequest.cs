...
{
    public class OnsSubscriptionSearchRequest : RpcAcsRequest<OnsSubscriptionSearchResponse>
    {
        public OnsSubscriptionSearchRequest()
            : base("Ons", "2017-09-18", "OnsSubscriptionSearch")
        {
        }
        ...
        public override OnsSubscriptionSearchResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsSubscriptionSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}