...
{
    public class OnsPublishCreateRequest : RpcAcsRequest<OnsPublishCreateResponse>
    {
        public OnsPublishCreateRequest()
            : base("Ons", "2017-09-18", "OnsPublishCreate")
        {
        }
        ...
        public override OnsPublishCreateResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsPublishCreateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}