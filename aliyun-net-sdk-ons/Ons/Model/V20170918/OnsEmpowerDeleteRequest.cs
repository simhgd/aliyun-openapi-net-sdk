...
{
    public class OnsEmpowerDeleteRequest : RpcAcsRequest<OnsEmpowerDeleteResponse>
    {
        public OnsEmpowerDeleteRequest()
            : base("Ons", "2017-09-18", "OnsEmpowerDelete")
        {
        }
        ...
        public override OnsEmpowerDeleteResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsEmpowerDeleteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}