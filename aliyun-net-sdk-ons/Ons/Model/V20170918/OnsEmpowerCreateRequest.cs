...
{
    public class OnsEmpowerCreateRequest : RpcAcsRequest<OnsEmpowerCreateResponse>
    {
        public OnsEmpowerCreateRequest()
            : base("Ons", "2017-09-18", "OnsEmpowerCreate")
        {
        }
		...
		public string EmpowerUser
		{
			...
			{
				empowerUser = value;
				DictionaryUtil.Add(QueryParameters, "EmpowerUser", value);
			}
		}
		...
		public int? Relation
		{
			...
			{
				relation = value;
				DictionaryUtil.Add(QueryParameters, "Relation", value.ToString());
			}
		}

        public override OnsEmpowerCreateResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsEmpowerCreateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}