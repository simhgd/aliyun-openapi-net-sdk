...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsConsumerGetConnectionRequest : RpcAcsRequest<OnsConsumerGetConnectionResponse>
    {
        public OnsConsumerGetConnectionRequest()
            : base("Ons", "2017-09-18", "OnsConsumerGetConnection")
        {
        }
        ...
        public override OnsConsumerGetConnectionResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
