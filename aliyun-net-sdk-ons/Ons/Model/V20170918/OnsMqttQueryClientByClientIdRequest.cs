...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsMqttQueryClientByClientIdRequest : RpcAcsRequest<OnsMqttQueryClientByClientIdResponse>
    {
        public OnsMqttQueryClientByClientIdRequest()
            : base("Ons", "2017-09-18", "OnsMqttQueryClientByClientId")
        {
        }
        ...
        public override OnsMqttQueryClientByClientIdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
