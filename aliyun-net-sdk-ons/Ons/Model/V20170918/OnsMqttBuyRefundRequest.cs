...
{
    public class OnsMqttBuyRefundRequest : RpcAcsRequest<OnsMqttBuyRefundResponse>
    {
        public OnsMqttBuyRefundRequest()
            : base("Ons", "2017-09-18", "OnsMqttBuyRefund")
        {
        }
        ...
        public override OnsMqttBuyRefundResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsMqttBuyRefundResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}