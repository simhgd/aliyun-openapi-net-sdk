...
{
    public class OnsTopicGetRequest : RpcAcsRequest<OnsTopicGetResponse>
    {
        public OnsTopicGetRequest()
            : base("Ons", "2017-09-18", "OnsTopicGet")
        {
        }
        ...
        public override OnsTopicGetResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsTopicGetResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}