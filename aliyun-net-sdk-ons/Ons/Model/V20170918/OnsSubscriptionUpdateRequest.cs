...
{
    public class OnsSubscriptionUpdateRequest : RpcAcsRequest<OnsSubscriptionUpdateResponse>
    {
        public OnsSubscriptionUpdateRequest()
            : base("Ons", "2017-09-18", "OnsSubscriptionUpdate")
        {
        }
        ...
        public override OnsSubscriptionUpdateResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsSubscriptionUpdateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}