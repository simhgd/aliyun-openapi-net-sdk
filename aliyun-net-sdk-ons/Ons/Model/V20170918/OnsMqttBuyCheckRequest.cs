...
{
    public class OnsMqttBuyCheckRequest : RpcAcsRequest<OnsMqttBuyCheckResponse>
    {
        public OnsMqttBuyCheckRequest()
            : base("Ons", "2017-09-18", "OnsMqttBuyCheck")
        {
        }
        ...
        public override OnsMqttBuyCheckResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsMqttBuyCheckResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}