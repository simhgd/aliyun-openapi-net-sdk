...
namespace Aliyun.Acs.Ons.Model.V20170918
{
    public class OnsMqttQueryHistoryOnlineRequest : RpcAcsRequest<OnsMqttQueryHistoryOnlineResponse>
    {
        public OnsMqttQueryHistoryOnlineRequest()
            : base("Ons", "2017-09-18", "OnsMqttQueryHistoryOnline")
        {
        }
        ...
        public override OnsMqttQueryHistoryOnlineResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
