...
{
    public class OnsMqttQueryTraceByTraceIdRequest : RpcAcsRequest<OnsMqttQueryTraceByTraceIdResponse>
    {
        public OnsMqttQueryTraceByTraceIdRequest()
            : base("Ons", "2017-09-18", "OnsMqttQueryTraceByTraceId")
        {
        }
        ...
        public override OnsMqttQueryTraceByTraceIdResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsMqttQueryTraceByTraceIdResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}