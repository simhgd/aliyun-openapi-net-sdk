...
{
    public class OnsTopicSearchRequest : RpcAcsRequest<OnsTopicSearchResponse>
    {
        public OnsTopicSearchRequest()
            : base("Ons", "2017-09-18", "OnsTopicSearch")
        {
        }
        ...
        public override OnsTopicSearchResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsTopicSearchResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}