...
{
    public class OnsRegionListRequest : RpcAcsRequest<OnsRegionListResponse>
    {
        public OnsRegionListRequest()
            : base("Ons", "2017-09-18", "OnsRegionList")
        {
        }
        ...
        public override OnsRegionListResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsRegionListResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}