...
{
    public class OnsPublishDeleteRequest : RpcAcsRequest<OnsPublishDeleteResponse>
    {
        public OnsPublishDeleteRequest()
            : base("Ons", "2017-09-18", "OnsPublishDelete")
        {
        }
        ...
        public override OnsPublishDeleteResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return OnsPublishDeleteResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}