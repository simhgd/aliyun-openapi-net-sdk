...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class ImportDataForSQLServerRequest : RpcAcsRequest<ImportDataForSQLServerResponse>
    {
        ...
        public override ImportDataForSQLServerResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return ImportDataForSQLServerResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}