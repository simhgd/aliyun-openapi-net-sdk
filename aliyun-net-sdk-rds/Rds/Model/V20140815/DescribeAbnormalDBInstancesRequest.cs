...
{
    public class DescribeAbnormalDBInstancesRequest : RpcAcsRequest<DescribeAbnormalDBInstancesResponse>
    {
        public DescribeAbnormalDBInstancesRequest()
            : base("Rds", "2014-08-15", "DescribeAbnormalDBInstances", "rds", "openAPI")
        {
        }
        ...
        public override DescribeAbnormalDBInstancesResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeAbnormalDBInstancesResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}