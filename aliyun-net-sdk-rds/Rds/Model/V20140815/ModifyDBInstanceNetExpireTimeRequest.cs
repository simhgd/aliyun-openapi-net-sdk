...
namespace Aliyun.Acs.Rds.Model.V20140815
{
    public class ModifyDBInstanceNetExpireTimeRequest : RpcAcsRequest<ModifyDBInstanceNetExpireTimeResponse>
    {
        public ModifyDBInstanceNetExpireTimeRequest()
            : base("Rds", "2014-08-15", "ModifyDBInstanceNetExpireTime", "rds", "openAPI")
        {
        }
        ...
        public override ModifyDBInstanceNetExpireTimeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
