...
{
	public class DescribeBackupSetsForSecurityResponse : AcsResponse
	{
		...
		private List<DescribeBackupSetsForSecurity_Backup> items;
		...
		public List<DescribeBackupSetsForSecurity_Backup> Items
		{
			get
			{
				return items;
		...
		public class DescribeBackupSetsForSecurity_Backup
		{
