...
{
    public class DescribeBackupSetsForSecurityRequest : RpcAcsRequest<DescribeBackupSetsForSecurityResponse>
    {
        public DescribeBackupSetsForSecurityRequest()
            : base("Rds", "2014-08-15", "DescribeBackupSetsForSecurity", "rds", "openAPI")
        {
        }
        ...
        public override DescribeBackupSetsForSecurityResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeBackupSetsForSecurityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}