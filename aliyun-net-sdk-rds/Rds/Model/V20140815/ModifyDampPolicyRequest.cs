...
{
    public class ModifyDampPolicyRequest : RpcAcsRequest<ModifyDampPolicyResponse>
    {
        public ModifyDampPolicyRequest()
            : base("Rds", "2014-08-15", "ModifyDampPolicy", "rds", "openAPI")
        {
        }
        ...
        public override ModifyDampPolicyResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return ModifyDampPolicyResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}