...
{
    public class CloneDBInstanceForSecurityRequest : RpcAcsRequest<CloneDBInstanceForSecurityResponse>
    {
        public CloneDBInstanceForSecurityRequest()
            : base("Rds", "2014-08-15", "CloneDBInstanceForSecurity", "rds", "openAPI")
        {
        }
        ...
        public override CloneDBInstanceForSecurityResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return CloneDBInstanceForSecurityResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}