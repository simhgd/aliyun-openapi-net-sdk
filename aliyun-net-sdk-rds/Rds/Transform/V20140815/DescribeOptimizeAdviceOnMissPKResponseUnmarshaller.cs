...
namespace Aliyun.Acs.Rds.Transform.V20140815
{
    ...
    {
        public static DescribeOptimizeAdviceOnMissPKResponse Unmarshall(UnmarshallerContext context)
        {
			DescribeOptimizeAdviceOnMissPKResponse describeOptimizeAdviceOnMissPKResponse = new DescribeOptimizeAdviceOnMissPKResponse();

			describeOptimizeAdviceOnMissPKResponse.HttpResponse = context.HttpResponse;
			describeOptimizeAdviceOnMissPKResponse.RequestId = context.StringValue("DescribeOptimizeAdviceOnMissPK.RequestId");
			describeOptimizeAdviceOnMissPKResponse.TotalRecordsCount = context.IntegerValue("DescribeOptimizeAdviceOnMissPK.TotalRecordsCount");
