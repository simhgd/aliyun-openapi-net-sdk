...
namespace Aliyun.Acs.vod.Model.V20170321
{
    public class GetCDNStatisSumRequest : RpcAcsRequest<GetCDNStatisSumResponse>
    {
        public GetCDNStatisSumRequest()
            : base("vod", "2017-03-21", "GetCDNStatisSum", "vod", "openAPI")
        {
        }
        ...
        public override GetCDNStatisSumResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return GetCDNStatisSumResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}