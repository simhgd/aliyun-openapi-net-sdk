...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class GetApgroupDetailedConfigRequest : RpcAcsRequest<GetApgroupDetailedConfigResponse>
    {
        public GetApgroupDetailedConfigRequest()
            : base("cloudwf", "2017-03-28", "GetApgroupDetailedConfig")
        {
        }
        ...
        public override GetApgroupDetailedConfigResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
