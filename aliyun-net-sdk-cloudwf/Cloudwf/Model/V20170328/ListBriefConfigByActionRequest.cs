...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class ListBriefConfigByActionRequest : RpcAcsRequest<ListBriefConfigByActionResponse>
    {
        public ListBriefConfigByActionRequest()
            : base("cloudwf", "2017-03-28", "ListBriefConfigByAction")
        {
        }
        ...
        public override ListBriefConfigByActionResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
