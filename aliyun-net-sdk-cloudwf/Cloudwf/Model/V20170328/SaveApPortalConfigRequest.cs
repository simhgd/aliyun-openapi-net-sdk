...
namespace Aliyun.Acs.cloudwf.Model.V20170328
{
    public class SaveApPortalConfigRequest : RpcAcsRequest<SaveApPortalConfigResponse>
    {
        public SaveApPortalConfigRequest()
            : base("cloudwf", "2017-03-28", "SaveApPortalConfig")
        {
        }
        ...
        public override SaveApPortalConfigResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
