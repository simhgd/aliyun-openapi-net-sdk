...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForUpdatingContactInfoRequest : RpcAcsRequest<SaveBatchTaskForUpdatingContactInfoResponse>
    {
        public SaveBatchTaskForUpdatingContactInfoRequest()
            : base("Domain_intl", "2017-12-18", "SaveBatchTaskForUpdatingContactInfo", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForUpdatingContactInfoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
