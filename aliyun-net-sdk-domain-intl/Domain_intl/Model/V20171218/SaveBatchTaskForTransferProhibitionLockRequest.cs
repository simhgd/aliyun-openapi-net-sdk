...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForTransferProhibitionLockRequest : RpcAcsRequest<SaveBatchTaskForTransferProhibitionLockResponse>
    {
        public SaveBatchTaskForTransferProhibitionLockRequest()
            : base("Domain_intl", "2017-12-18", "SaveBatchTaskForTransferProhibitionLock", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForTransferProhibitionLockResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
