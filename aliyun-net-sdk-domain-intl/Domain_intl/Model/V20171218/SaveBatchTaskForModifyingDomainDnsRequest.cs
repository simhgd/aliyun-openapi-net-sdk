...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForModifyingDomainDnsRequest : RpcAcsRequest<SaveBatchTaskForModifyingDomainDnsResponse>
    {
        public SaveBatchTaskForModifyingDomainDnsRequest()
            : base("Domain_intl", "2017-12-18", "SaveBatchTaskForModifyingDomainDns", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForModifyingDomainDnsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
