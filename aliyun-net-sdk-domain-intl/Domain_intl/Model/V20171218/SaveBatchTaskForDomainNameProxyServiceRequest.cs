...
namespace Aliyun.Acs.Domain_intl.Model.V20171218
{
    public class SaveBatchTaskForDomainNameProxyServiceRequest : RpcAcsRequest<SaveBatchTaskForDomainNameProxyServiceResponse>
    {
        public SaveBatchTaskForDomainNameProxyServiceRequest()
            : base("Domain_intl", "2017-12-18", "SaveBatchTaskForDomainNameProxyService", "domain", "openAPI")
        {
        }
        ...
        public override SaveBatchTaskForDomainNameProxyServiceResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
