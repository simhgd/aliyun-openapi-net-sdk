...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class ModifyInstanceMaintainTimeRequest : RpcAcsRequest<ModifyInstanceMaintainTimeResponse>
    {
        public ModifyInstanceMaintainTimeRequest()
            : base("R_kvstore", "2015-01-01", "ModifyInstanceMaintainTime", "redisa", "openAPI")
        {
        }
        ...
        public override ModifyInstanceMaintainTimeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
