...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class QueryTaskRequest : RpcAcsRequest<QueryTaskResponse>
    {
        public QueryTaskRequest()
            : base("R_kvstore", "2015-01-01", "QueryTask", "redisa", "openAPI")
        {
        }
        ...
        public override QueryTaskResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
