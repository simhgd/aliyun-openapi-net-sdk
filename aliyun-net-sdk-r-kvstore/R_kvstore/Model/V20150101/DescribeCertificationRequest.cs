...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeCertificationRequest : RpcAcsRequest<DescribeCertificationResponse>
    {
        public DescribeCertificationRequest()
            : base("R_kvstore", "2015-01-01", "DescribeCertification", "redisa", "openAPI")
        {
        }
        ...
        public override DescribeCertificationResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeCertificationResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}