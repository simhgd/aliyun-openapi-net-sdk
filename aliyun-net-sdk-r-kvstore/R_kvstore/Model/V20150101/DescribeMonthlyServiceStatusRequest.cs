...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class DescribeMonthlyServiceStatusRequest : RpcAcsRequest<DescribeMonthlyServiceStatusResponse>
    {
        public DescribeMonthlyServiceStatusRequest()
            : base("R_kvstore", "2015-01-01", "DescribeMonthlyServiceStatus", "redisa", "openAPI")
        {
        }
        ...
        public override DescribeMonthlyServiceStatusResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
            return DescribeMonthlyServiceStatusResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}