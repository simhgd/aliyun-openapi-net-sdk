...
namespace Aliyun.Acs.R_kvstore.Model.V20150101
{
    public class ModifyInstanceNetExpireTimeRequest : RpcAcsRequest<ModifyInstanceNetExpireTimeResponse>
    {
        public ModifyInstanceNetExpireTimeRequest()
            : base("R_kvstore", "2015-01-01", "ModifyInstanceNetExpireTime", "redisa", "openAPI")
        {
        }
        ...
        public override ModifyInstanceNetExpireTimeResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
