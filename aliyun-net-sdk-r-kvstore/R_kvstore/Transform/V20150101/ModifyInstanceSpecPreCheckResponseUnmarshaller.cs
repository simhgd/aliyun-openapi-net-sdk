...
namespace Aliyun.Acs.R_kvstore.Transform.V20150101
{
    ...
    {
        public static ModifyInstanceSpecPreCheckResponse Unmarshall(UnmarshallerContext context)
        {
			ModifyInstanceSpecPreCheckResponse modifyInstanceSpecPreCheckResponse = new ModifyInstanceSpecPreCheckResponse();

			modifyInstanceSpecPreCheckResponse.HttpResponse = context.HttpResponse;
