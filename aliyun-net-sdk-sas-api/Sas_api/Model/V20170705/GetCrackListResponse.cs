...
{
	public class GetCrackListResponse : AcsResponse
	{
		...
		private GetCrackList_Data data;
		...
		public class GetCrackList_Data
		{

			private long? total;

			private List<GetCrackList_Item> items;
			...
			public List<GetCrackList_Item> Items
			{
				get
				{
					return items;
			...
			public class GetCrackList_Item
			{
				...
				private List<GetCrackList_Detail> details;
				...
				public List<GetCrackList_Detail> Details
				{
					get
					{
						return details;
				...
				public class GetCrackList_Detail
				{
