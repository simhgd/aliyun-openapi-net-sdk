...
{
	public class GetThreatAnalyseListResponse : AcsResponse
	{
		...
		private GetThreatAnalyseList_Data data;
		...
		public GetThreatAnalyseList_Data Data
		{
			get
			{
				return data;
		...
		public class GetThreatAnalyseList_Data
		{

			private long? total;

			private List<GetThreatAnalyseList_Item> items;
			...
			public List<GetThreatAnalyseList_Item> Items
			{
				get
				{
					return items;
			...
			public class GetThreatAnalyseList_Item
			{
				...
				private List<GetThreatAnalyseList_Detail> details;
				...
				public List<GetThreatAnalyseList_Detail> Details
				{
					get
					{
						return details;
				...
				public class GetThreatAnalyseList_Detail
				{
