...
{
	public class GetSecurityEventListResponse : AcsResponse
	{
		...
		private GetSecurityEventList_Data data;
		...
		public GetSecurityEventList_Data Data
		{
			get
			{
				return data;
		...
		public class GetSecurityEventList_Data
		{

			private long? total;

			private List<GetSecurityEventList_Item> items;
			...
			public List<GetSecurityEventList_Item> Items
			{
				get
				{
					return items;
			...
			public class GetSecurityEventList_Item
			{
				...
				private List<GetSecurityEventList_Detail> details;
				...
				public List<GetSecurityEventList_Detail> Details
				{
					get
					{
						return details;
				...
				public class GetSecurityEventList_Detail
				{
