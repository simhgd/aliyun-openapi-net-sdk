...
namespace Aliyun.Acs.Cms.Model.V20170301
{
    public class DescribeAlarmHistoryRequest : RpcAcsRequest<DescribeAlarmHistoryResponse>
    {
        public DescribeAlarmHistoryRequest()
            : base("Cms", "2017-03-01", "DescribeAlarmHistory", "cms", "openAPI")
        {
        }
        ...
        public override DescribeAlarmHistoryResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
