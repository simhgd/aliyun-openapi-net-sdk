...
namespace Aliyun.Acs.Cms.Model.V20170301
{
    public class DeleteMyGroupsRequest : RpcAcsRequest<DeleteMyGroupsResponse>
    {
        public DeleteMyGroupsRequest()
            : base("Cms", "2017-03-01", "DeleteMyGroups", "cms", "openAPI")
        {
        }
        ...
        public override DeleteMyGroupsResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
