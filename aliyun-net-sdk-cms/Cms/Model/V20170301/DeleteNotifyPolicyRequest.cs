...
namespace Aliyun.Acs.Cms.Model.V20170301
{
    public class DeleteNotifyPolicyRequest : RpcAcsRequest<DeleteNotifyPolicyResponse>
    {
        public DeleteNotifyPolicyRequest()
            : base("Cms", "2017-03-01", "DeleteNotifyPolicy", "cms", "openAPI")
        {
        }
        ...
        public override DeleteNotifyPolicyResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
