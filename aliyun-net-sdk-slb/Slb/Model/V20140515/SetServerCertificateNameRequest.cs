...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class SetServerCertificateNameRequest : RpcAcsRequest<SetServerCertificateNameResponse>
    {
        public SetServerCertificateNameRequest()
            : base("Slb", "2014-05-15", "SetServerCertificateName")
        {
        }
        ...
        public override SetServerCertificateNameResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
