...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class RemoveBackendServersRequest : RpcAcsRequest<RemoveBackendServersResponse>
    {
        public RemoveBackendServersRequest()
            : base("Slb", "2014-05-15", "RemoveBackendServers")
        {
        }
        ...
        public override RemoveBackendServersResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
