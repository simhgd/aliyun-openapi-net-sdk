...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class RemoveListenerWhiteListItemRequest : RpcAcsRequest<RemoveListenerWhiteListItemResponse>
    {
        public RemoveListenerWhiteListItemRequest()
            : base("Slb", "2014-05-15", "RemoveListenerWhiteListItem")
        {
        }
        ...
        public override RemoveListenerWhiteListItemResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
