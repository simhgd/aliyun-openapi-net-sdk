...
namespace Aliyun.Acs.Slb.Model.V20140515
{
    public class MoveResourceGroupRequest : RpcAcsRequest<MoveResourceGroupResponse>
    {
        public MoveResourceGroupRequest()
            : base("Slb", "2014-05-15", "MoveResourceGroup", "slb", "openAPI")
        {
        }
        ...
        public override MoveResourceGroupResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
